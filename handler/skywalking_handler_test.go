...
func TestProviderHandlerName(t *testing.T) {
	...
	assert.Equal(t, h.Name(), chassisHandler.SkyWalkingProvider)
}
...
func TestConsumerHandlerName(t *testing.T) {
	...
	assert.Equal(t, c.Name(), chassisHandler.SkyWalkingConsumer)
}
...
func TestNewConsumer(t *testing.T) {
	...
	assert.NotEqual(t, h, nil)
	assert.Equal(t, h.Name(), chassisHandler.SkyWalkingConsumer)
}
